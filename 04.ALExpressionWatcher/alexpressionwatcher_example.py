...
def onExpressionReport(expression_value):
    print "Got ALExpressionWatcher signal with values: ", expression_value
    # you can check the expression value, though report_mode=2 gauanteed it is true
    if expression_value:
        print "You held the left bumper for at least 5 seconds, then let go!"


if __name__ == "__main__":
    # python alexpressionwatcher_example.py --qi-url=tcp://192.168.0.143:9559
    ...
    app.run()  # Will lock until the app connection is destroyed, or ctrl+c
